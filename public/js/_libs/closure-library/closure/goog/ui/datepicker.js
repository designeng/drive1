 ...
 * @private
 */
goog.ui.DatePicker.prototype.birthdayYearMenu_ = false;
...
/**
 * @param {boolean} b Whether to use a birthday menu.
 */
goog.ui.DatePicker.prototype.setUseBirthdayYearMenu = function(b) {
  this.birthdayYearMenu_ = b;
};
...
goog.ui.DatePicker.prototype.showYearMenu_ = function(event) {
  ...
  for (var i = this.birthdayYearMenu_ ? -115 : -goog.ui.DatePicker.YEAR_MENU_RANGE_;
...
goog.ui.DatePicker.prototype.createMenu_ = function(srcEl, items, method,
  ...
  el.style.width = srcEl.clientWidth + (this.birthdayYearMenu_ ? 16 : 0) + 'px';
